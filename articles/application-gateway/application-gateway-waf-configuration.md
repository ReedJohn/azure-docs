...
- The file upload limit field is specified in MB and it governs the maximum allowed file upload size. This field can have a minimum value of 1 MB and a maximum of 500 MB for Large SKU or a minimum value of 1MB and a maximum of 100MB for Medium SKU Gateways. The default value for file upload limit is 100 MB.
